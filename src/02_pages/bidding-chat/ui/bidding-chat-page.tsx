...
import { cn } from '@/shared/lib/utils'; // Giả định bạn có helper cn, nếu không thay bằng template string
  ...
  return (
    <div className="relative flex flex-col w-full h-[calc(100vh-4rem)] bg-white dark:bg-slate-950 overflow-hidden">
      ...
      <main className="flex-1 z-10 w-full h-full flex flex-col relative overflow-hidden">
        {/* Render có điều kiện để giữ state chat ổn định hoặc mount/unmount tùy nhu cầu */}
      ...
      {/* Floating Sparkle Icon Decor (Optional) */}
